package by.korolenko.demothreads.ex18_count_down_latch;
...
public class Student extends Thread {
    ...
    public void run() {
        int i = 0;
        for (Task inWork : taskList) {   // на выполнение задания требуется некоторое время
            try {
        ...
        float averageMark = 0;
        for (Task inWork : taskList) {   // выполнение задания
