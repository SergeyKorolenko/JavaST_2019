...
public class Client extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            reading = true;
            System.out.println("Channel Client #" + this.getId() + " took channel #" + channel.getСhannelId());
            channel.using();
            ...
            if (channel != null) {
                reading = false;
                System.out.println("Channel Client #" + this.getId() + " : " + channel.getСhannelId() + " channel released");
